	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussxinwenxinxi`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
				...
				if(this.ruleForm.id){
					await this.$api.update(`discussxinwenxinxi`, this.ruleForm);
				}else{
					await this.$api.add(`discussxinwenxinxi`, this.ruleForm);
				}
				uni.setStorageSync('discussxinwenxinxiCleanType',true);
