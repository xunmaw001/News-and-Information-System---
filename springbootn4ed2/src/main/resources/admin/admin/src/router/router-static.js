...
import center from '@/views/center'
    ...
    import xinwenshipin from '@/views/modules/xinwenshipin/list'
    import discussxinwenshipin from '@/views/modules/discussxinwenshipin/list'
...
const routes = [{
	...
	path: '/xinwenshipin',
        name: '新闻视频',
        component: xinwenshipin
      }
      ,{
	path: '/discussxinwenshipin',
        name: '新闻视频评论',
        component: discussxinwenshipin
      }
      ,{
	path: '/storeup',
        name: '我的收藏管理',
